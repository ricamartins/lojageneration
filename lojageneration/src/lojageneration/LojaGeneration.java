	...
	public static void main(String[] args)throws InterruptedException {
		...
		case 'C': {
			...
			do {
				...
				System.out.printf("Digite o seu sexo \nM - Masculino \nF - Feminino \nQualquer letra(Escolha o que você se sinta à vontade!): ");
				...
				System.out.printf("\nA igreja do usuário %s é: %s",nomeUsuarios[contadorNovoUsuario],igrejaUsuarios[contadorNovoUsuario]);
		...
		case 'L':{
			System.out.print("\nVocê será direcionado para o Login da aplicação");
			Thread.sleep(3500);
			limpaTela();
